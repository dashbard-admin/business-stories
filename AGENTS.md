...
| `script_narrative_spine.txt` *(added 2026-06-08)* | S6 primary | `{incident_name}, {fact_ledger_json}, {target_words}, …` | Locks central question, timeline mode, protagonist desire, fatal misread, mid-roll tension, final image, and selected fact IDs before prose. |
